        ...
        <div class="form-container">
            <van-form @submit="onSubmit">
                <van-cell-group inset>
                    ...
                    <template v-for="(item, index) in state.vantForm.hardwareInfo">
                        ...
                        >
                            <template #input>
                                ...
                                />
                                <van-icon name="add-o" v-if="index === state.vantForm.hardwareInfo.length-1" @click="addHardware" /> 
                            </template>
                        </van-field>
                        <van-field
                            name="数量"
                    ...
                    >
                        <template #input>
                            <van-radio-group v-model="state.vantForm.conclusion" direction="horizontal">
